              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        await DefineDatePrescriptionMedical.selectDate(
                            ...
                            Expanded(
                              child: Text(
                                DateFormat('dd/MM/yyyy').format(
                                    providerPrescriptionMedical.getEmissaoEm!),
                                textAlign: TextAlign.left,
                                style:
                                    FontGoogle.textNormalGreyGoogle(size: size),
                              ),
                            ),
                            const Icon(
                    ...
                    Text(
                      'Data de validade:',
                      style: FontGoogle.textSubTitleGoogle(size: size * .95),
                    ),
                    SizedBox(height: size.height * .01),
                    GestureDetector(
                      onTap: () async {
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: Text(
                                DateFormat('dd/MM/yyyy').format(
                                    providerPrescriptionMedical.getValidade!),
                                textAlign: TextAlign.left,
                                style:
                                    FontGoogle.textNormalGreyGoogle(size: size),
                              ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Bounceable(
                            onTap: () async {
                              await DefineDatePrescriptionMedical.selectTime(
                                  context: context, typeEmissao: true);
                              setState(() {});
                            },
                            child: Text(
                              ...
                              DateFormat('HH:mm').format(
                                DateTime(
                                  ...
                                  0,
                                  0,
                                  providerPrescriptionMedical.getTimeOfDay.hour,
                ...
                Bounceable(
                  onTap: () async {
                    if (controllerQtdeDosagem.text.isEmpty ||
                        (int.tryParse(controllerQtdeDosagem.text) ?? 0) <= 0) {
                      _checkValuesMsg(
                    ...
                    if (controllerQtdeDias.text.isEmpty ||
                        (int.tryParse(controllerQtdeDias.text) ?? 0) <= 0) {
                      _checkValuesMsg('Por favor, informe a dosagem por hora');
                      return;
                    }

                    final int? qtdeDias = int.tryParse(controllerQtdeDias.text);
                    final num? qtdeDosagem =
                        num.tryParse(controllerQtdeDosagem.text);
                    if (qtdeDias == null || qtdeDosagem == null) {
                      scaffoldMessengerKeyDataPrescription.currentState
                          ?.showSnackBar(
                        const SnackBar(
                      ...
                      bool response =
                          await providerPrescriptionMedical.includePrescription(
                              context: context,
