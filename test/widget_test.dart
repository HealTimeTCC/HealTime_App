...
void main() async {
  test('Retornar os médicos cadastrados', () async {
  ...
  test('Retornar as especialidades cadastradas', () async {
    Uri uriApi =
  ...
  test('Retornar dados do usuário', () async {
    DtoPessoa dtoPessoa =
  ...
  test('Obter informações referentes a consultas', () async {
